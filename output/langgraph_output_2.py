...
def route_based_on_condition(state: WorkflowState) -> str:
    ...
    if str(project_root) notin sys.path:
...
workflow.add_conditional_edges("sys.path.insert", route_based_on_condition)





workflow.add_conditional_edges("start", route_based_on_condition)



workflow.add_conditional_edges("print", route_based_on_condition)



# Handle for loop logic
workflow.add_edge("wf.profile_data.items", "print")



workflow.add_conditional_edges("main", route_based_on_condition)
